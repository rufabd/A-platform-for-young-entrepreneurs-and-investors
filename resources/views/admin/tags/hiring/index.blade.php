...
<div class="container" style="margin-top: 100px">
    <div class="d-sm-flex align-items-center justify-content-center" style="margin-bottom: 40px">
        <h1 class="h2 mb-0">Project Hiring Tags</h1>
    </div>
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        Create New Project Hiring Tag
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin-tags-projecthiring-store') }}">
                            @csrf
    ...
    <div class="row">
        <div class="card  mx-auto" style="width: 53rem">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <form method="GET" action="{{ route('admin-tags-projecthiring') }}">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($phiringtags as $phiringtag)
                            <tr>
                                <th scope="row">{{ $phiringtag->id }}</th>
                                <td>{{ $phiringtag->name }}</td>
                                <td>
